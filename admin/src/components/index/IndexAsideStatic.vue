      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgb(205, 244, 234)"
          })
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		/*background-color: rgb(7, 199, 150) !important;*/
     ...
     /* color: rgba(0, 0, 0, 1);*/
			...
			/*	color: #07c796 !important;*/
                ...
                &.is-active {
                  ...
                  background-color: rgba(148, 238, 212, 0.98) !important;
          ...
          background-color: rgb(200, 238, 228) !important;
					box-shadow: 0 0 6px rgba(30, 144, 255, 0);
					text-align: center;
				}
			}
...
.el-menu--horizontal .el-menu--popup {
		...
		border-style: solid;
		border-color: rgba(0,0,0,.3);
		background-color: rgba(136, 18, 18, 0);
		box-shadow: 0 0 6px rgba(0, 0, 0, .3);
		min-width: auto;
		}
