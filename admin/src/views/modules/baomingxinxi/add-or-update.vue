  ...
  <div class="addEdit-block">
    ...
    >
      <el-row >
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="用户名称" prop="username">
            <el-input v-model="ruleForm.username" :disabled="true"
                      placeholder="用户名称" clearable readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="用户名称" prop="用户名称">
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="活动名称" prop="活动名称">
              <el-input v-model="ruleForm.activityname"
        ...
        <el-col :span="12">
          <el-form-item class="date" v-if="type!='info'" label="日期" prop="addtime">
            <el-date-picker
          ...
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.addtime" label="日期" prop="addtime">
...
export default {
  ...
  created() {
    /*this.ruleForm.addtime = this.getCurDate()*/
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.statusOptions = "通过,不通过,审核中".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
