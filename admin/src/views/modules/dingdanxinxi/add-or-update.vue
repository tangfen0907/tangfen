<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="活动地区" prop="huodongdiqu">
            <el-input v-model="ruleForm.huodongdiqu"
                      placeholder="活动地区" clearable :readonly="ro.huodongdiqu"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="活动费用" prop="huodongfeiyong">
            <el-input v-model="ruleForm.huodongfeiyong"
                      placeholder="活动费用" clearable :readonly="ro.huodongfeiyong"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="活动费用" prop="huodongfeiyong">
              <el-input v-model="ruleForm.huodongfeiyong"
                        placeholder="活动费用" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
