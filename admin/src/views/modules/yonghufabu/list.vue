  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.biaoti"
                      clearable placeholder="标题" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.biaoti"
                      clearable placeholder="标题" suffix-icon="el-icon-search"></el-input>
          ...
          <el-form-item class="select" label="类型" prop="leixing">
            <el-select v-model="searchForm.leixing" clearable placeholder="请选择类型" @change="leixingChange">
              <el-option
        ...
        <el-row :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item>
            <el-button
                v-if="isAuth('yonghufabu','新增') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1"
                icon="el-icon-plus"
                type="success"
            ...
            <el-button
                v-if="isAuth('yonghufabu','新增') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
                type="success"
                @click="addOrUpdateHandler()"
            >{{ contents.btnAdAllFont == 1 ? '新增' : '' }}<i class="el-icon-plus el-icon--right"/></el-button>
            <el-button
                v-if="isAuth('yonghufabu','新增') && contents.btnAdAllIcon == 0"
                type="success"
                @click="addOrUpdateHandler()"
            >{{ contents.btnAdAllFont == 1 ? '新增' : '' }}
            </el-button>
            <el-button
                v-if="isAuth('yonghufabu','删除') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1 && contents.tableSelection"
            ...
            <el-button
                v-if="isAuth('yonghufabu','删除') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2 && contents.tableSelection"
                :disabled="dataListSelections.length <= 0"
                type="danger"
                @click="deleteHandler()"
            >{{ contents.btnAdAllFont == 1 ? '删除' : '' }}<i class="el-icon-delete el-icon--right"/></el-button>
            <el-button
                v-if="isAuth('yonghufabu','删除') && contents.btnAdAllIcon == 0 && contents.tableSelection"
                :disabled="dataListSelections.length <= 0"
                type="danger"
                @click="deleteHandler()"
            >{{ contents.btnAdAllFont == 1 ? '删除' : '' }}
      ...
      <div class="table-content">
        <el-table v-if="isAuth('yonghufabu','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" :header-align="contents.tableAlign" :sortable="contents.tableSortable"
            ...
            <template slot-scope="scope">
              <div v-if="scope.row.tupian">
                <img :src="$base.url+scope.row.tupian.split(',')[0]" height="100" width="100">
              </div>
              <div v-else>无图片</div>
            </template>
          </el-table-column>
          ...
          <el-table-column :align="contents.tableAlign" :header-align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('yonghufabu','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('yonghufabu','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('yonghufabu','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
                         @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if=" isAuth('yonghufabu','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if=" isAuth('yonghufabu','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if=" isAuth('yonghufabu','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('yonghufabu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('yonghufabu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('yonghufabu','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
