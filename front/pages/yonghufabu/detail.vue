		...
		<view class="container">
			...
			<view class="detail-content">
				...
				<view class="name shop-title"
					:style='{"padding":"0 24rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"#fff","backgroundColor":"#fff","color":"#000","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"60rpx","fontSize":"32rpx","borderStyle":"solid"}'>
					标题：{{detail.biaoti}}
				</view>
			...
			<view class="time-content"
				...
				<view class="content"
					...
					<rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;"
						:nodes="processContent(detail.neirong)"></rich-text>
				</view>
			</view>
			...
			<view class="bottom-content cu-bar bg-white tabbar border shop"
				:style='{"padding":"0px","boxShadow":"rgb(0 0 0 / 0%) 0px 0px 12rpx","margin":"0px","borderColor":"rgb(204, 204, 204)","backgroundColor":"rgb(255, 255, 255)","borderRadius":"0px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100rpx"}'>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('yonghufabu', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussyonghufabu/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
			...
			async onFinishTap() {
				...
				await this.$api.update('yonghufabu', this.detail);
				this.$utils.msg('审核成功');
